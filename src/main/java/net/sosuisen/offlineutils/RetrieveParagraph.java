...
/**
 * RetrieveParagraph
 * This is for testing the paragraph_store.json
 */
public class RetrieveParagraph {

    public static void main(String[] args) {
        try {
            if (args.length != 1) {
                System.out.println("Usage: mvn clean package exec:java -Dexec.mainClass=\"net.sosuisen.RetrieveParagraph\" -Dexec.args=\"path-to-paragraph_store.json\"");
                System.exit(1);
            }
